L.Control.LocationList = L.Control.extend({
	...
	options: {
		position: 'topright',
		showList: true,		
		locationsList : [ {title: 'Tunguu Campus', latlng: [-6.19918, 39.30674], zoom: 18},
						  {title: 'Vuga Campus', latlng: [-6.16567, 39.1917], zoom: 18},
						  {title: 'Beit-el-Ras Campus', latlng: [-6.11871, 39.21181], zoom: 18}],
		nextText : '->',
		nextTitle : 'Next',
		prevText : '<-',
		prevTitle : 'Previous'
